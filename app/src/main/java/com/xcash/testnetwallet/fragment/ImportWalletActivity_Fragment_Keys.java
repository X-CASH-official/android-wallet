...
public class ImportWalletActivity_Fragment_Keys extends BaseFragment {
    ...
    private EditText editTextInputAddressKey;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_import_wallet_fragment_keys, container, false);
    ...
    protected void initUi() {
        getTypeArrayColor();
        editTextPrivateViewKey = (EditText) view.findViewById(R.id.editTextPrivateViewKey);
        editTextPrivateSpendKey = (EditText) view.findViewById(R.id.editTextPrivateSpendKey);
        editTextInputAddressKey = (EditText) view.findViewById(R.id.editTextInputAddressKey);
    ...
    private void restoreWallet() {
        ...
        try {
            walletOperateManager.importWalletKeys(set_wallet_name, set_wallet_password, set_wallet_description, addressKey, privateViewKey, privateSpendKey, blockHeight, new OnWalletDataListener.Stub() {
                @Override
