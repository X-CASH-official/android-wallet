 ...
 public class MainActivity extends NewBaseActivity {
     ...
     protected void initUi() {
         ...
         checkBoxExit = (CheckBox) activity_main_navigationview.findViewById(R.id.checkBoxExit);
         checkBoxExit.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
             @Override
             public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                Setting setting= TheApplication.getSetting();
                 if (b!=setting.isCloseServerWhenExit()){
                     setting.setCloseServerWhenExit(b);
     ...
     protected void initConfigUi() {
         ...
         if(TheApplication.getSetting().isCloseServerWhenExit()){
             ...
             public void onClick(View view) {
                 switch (view.getId()) {
                     ...
                     case R.id.relativeLayoutNodeSetting:
                         ...
                         intent3.putExtra(ActivityHelp.WALLET_KEY, wallet);
         ...
         if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
             if ((System.currentTimeMillis() - exitTime) > 2000) {
                 ...
                 if (checkBoxExit.isChecked()){
                     closeWallet();
                     TheApplication.getTheApplication().getWalletServiceHelper().unbindService();
                 }
             }
             return true;
         }
